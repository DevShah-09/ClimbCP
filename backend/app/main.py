...
from app.routers import sync_router, analytics_router, ratings_router, auth_router, topics_router, weaknesses_router, strengths_router, recommendations_router
